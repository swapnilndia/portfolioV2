...
export default function ContactPage() {
  ...
  const selectedCountry = useMemo(
    () =>
      COUNTRIES.find((c) => c.iso === formData.selectedIso) ??
          ...
          <Card className="contact-page__form-card">
            <form onSubmit={handleSubmit} className="contact-page__form">
                ...
                <div className="contact-page__phone-row">
                  <div className="contact-page__country-select-wrapper" ref={dropdownRef}>
                    ...
                    >
                      ...
                      <svg
                        className="contact-page__dropdown-arrow"
                        width="12"
                        height="12"
                        viewBox="0 0 12 12"
                        fill="none"
                    ...
                    {dropdownOpen && (
                      <div
                        className="contact-page__country-dropdown"
                        role="listbox"
                        aria-label="Country"
                      >
                          ...
                          {filteredCountries.length > 0 ? (
                            filteredCountries.map((country) => (
                              ...
                              >
                                ...
                                <span className="contact-page__country-dial">
                                  {country.dialCode}
                                </span>
                              </li>
                            ))
              ...
              {submitStatus === "success" && (
                <div className="contact-page__success">{t("form.success")}</div>
              )}

              {submitStatus === "error" && (
                <div className="contact-page__error">{submitErrorMessage || t("form.error")}</div>
              )}
