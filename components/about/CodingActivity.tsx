...
function getMonthLabels(weeks: (ContributionDay | null)[][]): { label: string; colIndex: number }[] {
    ...
    <div className="coding-activity__heatmap-wrap" ref={wrapRef}>
      <div className="coding-activity__heatmap-inner">
        <div
          ...
          style={{ gridTemplateColumns: `repeat(${weekCount}, ${CELL_SIZE}px)`, gap: `${CELL_GAP}px` }}
        >
...
const DIFFICULTIES = [
  ...
  { key: 'medium', label: 'Med.', fullLabel: 'Medium', solvedKey: 'mediumSolved', totalKey: 'totalMedium' },
      ...
      <div className="coding-activity__container">
        ...
        <div className="coding-activity__block">
          ...
          <div className="coding-activity__github-stats">
            {[
              ...
              { value: github?.currentStreak != null ? `${github.currentStreak}d` : undefined, label: 'current streak' },
        ...
        <div className="coding-activity__block">
          <div className="coding-activity__block-header">
            ...
            <div className="coding-activity__badges">
              {!loading && leetcode && (
                <span className="coding-activity__badge">Rank #{leetcode.ranking.toLocaleString()}</span>
              )}
            </div>
          </div>
          ...
          <div className="coding-activity__leetcode-chart">
            ...
            <div className="coding-activity__donut-wrapper">
              ...
              >
                ...
                {/* Center labels */}
                <text x={DONUT_CX} y="52" textAnchor="middle" className="coding-activity__donut-number">
                  {donutNumberText}
                </text>
                <text x={DONUT_CX} y="67" textAnchor="middle" className="coding-activity__donut-sub">
                  {donutSubText}
                </text>
                {!loading && leetcode && (
                  <text x={DONUT_CX} y="80" textAnchor="middle" className="coding-activity__donut-acc">
                    {donutFooterText}
                  </text>
                )}
              </svg>
              ...
              {DIFFICULTIES.map(({ key, label, solvedKey, totalKey }) => {
                ...
                return (
                  <div
                    ...
                    onMouseLeave={() => setHoveredDiff(null)}
                  >
                    <span className={`coding-activity__diff-label coding-activity__diff-label--${key}`}>
                      {label}
                    </span>
